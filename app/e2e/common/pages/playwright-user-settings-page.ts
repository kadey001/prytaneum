...
export class PlaywrightUserSettingsPage {
    ...
    constructor(page: Page, device: Device) {
        this.page = page;
        this.device = device;
        this.emailField = this.page.locator(`text=Current email:`);
    ...
    async setEmailField(email: string) {
        this.emailField = this.page.locator(`text=Current email: ${email}@example.com`);
    }
    ...
    async updatePassword(oldPassword: string, newPassword: string) {
        ...
        await this.page
            .locator('[aria-label="Enter your new password again"] input[type="password"]')
            .fill(newPassword);
