...
export default function organizerTests() {
    test.describe('Items Present', () => {
        test.fixme('I can see an ongoing event I created', async ({ dashboardPageOrganizer }) => {
            // Go to Dashboard
        ...
        test.fixme('I can see sections for Current Events and Upcoming Events.', async ({ dashboardPageOrganizer }) => {
            // Go to Dashboard
            await dashboardPageOrganizer.goto();
    ...
    test.describe('Navigation', () => {
        test.fixme('I can visit live feed of ongoing event.', async ({ dashboardPageOrganizer }) => {
            // Go to Dashboard
            await dashboardPageOrganizer.goto();
        ...
        test.fixme('I am directed back to dashboard upon refresh.', async ({ dashboardPageOrganizer }) => {
            // Go to Dashboard
            await dashboardPageOrganizer.goto();
        ...
        test.fixme('I am directed to landing page if not logged in.', async ({ browser }) => {
